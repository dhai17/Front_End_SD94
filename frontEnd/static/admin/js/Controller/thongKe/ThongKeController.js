app.controller("thongKeController", function ($scope, $http) {
     ...
     $scope.thangLoad = "";
     $http.get("http://localhost:8080/thongKe/thongKeTheoThang", { headers })
          .then(function (response) {
     ...
     $scope.namLoad = "";
     $http.get("http://localhost:8080/thongKe/thongKeTheoNam", { headers })
          .then(function (response) {
     ...
     $http.get("http://localhost:8080/thongKe/sanPhambanChay", { headers })
          .then(function (response) {
     ...
     $scope.locTheoThang = function (thang) {
          ...
          $http.get("http://localhost:8080/thongKe/thongKeTheothangTruyenVao/" + thang, { headers })
               .then(function (response) {
                    $scope.tongTienThang = 0;
                    $scope.hangBanDuocThang = 0;
     ...
     $scope.locTheoNam = function (nam) {
          $scope.namLoad = nam;
          $http.get("http://localhost:8080/thongKe/thongKeTheoNamTruyenVao/" + nam, { headers })
               .then(function (response) {
                    let data = response.data;
