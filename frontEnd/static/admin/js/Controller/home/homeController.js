...
app.config(function ($routeProvider) {
  $routeProvider
    ...
    .when("/CTChoXacNhan", {
      templateUrl:
        "/templates/admin/hoaDon/details.Online/ChiTietChoXacNhan.html",
      controller: "CTChoXacNhan",
    })
    .when("/CTChoGiaoHang", {
      templateUrl:
        "/templates/admin/hoaDon/details.Online/ChiTietChoGiaoHang.html",
      controller: "CTChoGiaoHang",
    })
    .when("/CTDangGiaoHang", {
      templateUrl:
        "/templates/admin/hoaDon/details.Online/ChiTietDangGiaoHang.html",
      controller: "CTDangGiaoHang",
    })
    .when("/CTDaGiaoHang", {
      templateUrl:
        "/templates/admin/hoaDon/details.Online/ChiTietDaGiaoHang.html",
    ...
    .when("/CTXacNhanDaGiao", {
      templateUrl:
        "/templates/admin/hoaDon/details.Online/ChiTietXacNhanDaGiao.html",
    ...
    .when("/hdct_dahuy", {
      templateUrl:
        "/templates/admin/hoaDonTaiQuay/hoaDonChiTiet/HDCT_DaHuy.html",
      controller: "HDCT_DaHuyController",
    })
    .when("/hdct_dathanhtoan", {
      templateUrl:
        "/templates/admin/hoaDonTaiQuay/hoaDonChiTiet/HDCT_DaThanhToan.html",
