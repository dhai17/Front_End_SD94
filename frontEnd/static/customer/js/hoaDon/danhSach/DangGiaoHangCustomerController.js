app.controller("dangGiaoHangCustomerController", function ($scope, $http) {
     ...
     $http.get("http://localhost:8080/customer/donHang/dangGiaoHang/" + decodedToken.email, { headers })
     ...
     $scope.DaNhanDuocHang = function (hoaDon) {
          Swal.fire({
               ...
               if (result.isConfirmed) {
                    ...
                    $http.post("http://localhost:8080/customer/donHang/daNhanDuocHang/", data, { headers })
                         .then(function (response) {
                              Swal.fire({
                                   icon: "success",
     ...
     $scope.DaNhanTatCa = function () {
          Swal.fire({
               ...
               if (result.isConfirmed) {
                    ...
                    $http.post("http://localhost:8080/customer/donHang/daNhanTatCa/", data, { headers })
                         .then(function (response) {
                              Swal.fire({
                                   icon: "success",
                                   title: "Thao tác thành công",
