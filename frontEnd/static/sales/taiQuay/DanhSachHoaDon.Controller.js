app.controller("danhSachHoaDonController", function ($scope, $http) {
    ...
    $http.get("http://localhost:8080/api/banHang/taiQuay/danhSachHoaDon", { headers })
    ...
    $scope.taoHoaDon = function () {
        ...
        $http.post("http://localhost:8080/api/banHang/taiQuay/taoHoaDon", data, { headers })
            .then(function (response) {
    ...
    $scope.xoaHoaDon = function (hoaDon) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $http.post("http://localhost:8080/api/banHang/taiQuay/xoaHoaDon", data, { headers })
                    .then(function (response) {
                        const hoaDon = response.data;
