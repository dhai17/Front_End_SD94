app.controller(
  ...
  function ($scope, $http, $routeParams) {
    ...
    $http
      .get(
        "http://localhost:8080/api/banHang/taiQuay/getHoaDonChitiet/" +
          id_HoaDonTaiQuay,
        { headers }
      )
    ...
    $http
      .get(
        "http://localhost:8080/api/banHang/taiQuay/getHoaDon/" +
          id_HoaDonTaiQuay,
        { headers }
      )
      .then(function (response) {
    ...
    $scope.onKhuyenMaiChange = function () {
      $scope.themMaGiamGia = function () {
        ...
        $http
          .post(
            "http://localhost:8080/api/banHang/taiQuay/add/khuyenMai",
            data,
            { headers }
          )
          .then(function (response) {
    ...
    $scope.themSanPham = function () {
      ...
      window.location.href =
        "#!/danhSachSanPham/taiQuay?id_hoaDon=" + id_HoaDonTaiQuay;
    };
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          if ($scope.tienThieu !== 0) {
            ...
            $http
              .post(
                "http://localhost:8080/api/banHang/taiQuay/thanhToan",
                data,
                {
                  headers,
                }
              ...
              .then(function (response) {
                Swal.fire({
                  ...
                  $http
                    .post(
                      "http://localhost:8080/api/banHang/taiQuay/inHoaDon/",
                      data,
                    ...
                    .then(function (response) {
                      ...
                      if (newWindow) {
                        ...
                        alert(
                          "Vui lòng cho phép trình duyệt mở popup để xem và lưu hóa đơn."
                        );
                      }
                    });
                  window.location.href = "#!/danhSachHoaDon";
