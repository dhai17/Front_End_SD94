app.controller("MuaNgayController", function ($scope, $routeParams, $http) {
  ...
  $http
    .get("http://localhost:8080/api/muaNgay/getHoaDon/" + id_HoaDonMuaNgay)
  ...
  $http
    .get(
      "http://localhost:8080/api/muaNgay/getHoaDonChiTiet/" + id_HoaDonMuaNgay
    )
    .then(function (response) {
          ...
          .then(function (response) {
            Swal.fire({
              ...
              window.location.href =
                "http://127.0.0.1:5501/templates/customer/home/TrangChu.html#!/";
            });
          })
          .catch(function (e) {
