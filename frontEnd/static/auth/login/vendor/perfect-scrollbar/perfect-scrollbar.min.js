...
!(function (t, e) {
    ...
    function b(t, i) {
        ...
        i.isScrollbarYUsingRight
            ? i.isRtl
                ? (r.right = i.contentWidth - (i.negativeScrollAdjustment + t.scrollLeft) - i.scrollbarYRight - i.scrollbarYOuterWidth)
        ...
        L = function (t) {
            ...
            (t.containerWidth = e.clientWidth),
                ...
                t.scrollbarXActive
                    ...
                    : (e.classList.remove(m.state.active('x')), (t.scrollbarXWidth = 0), (t.scrollbarXLeft = 0), y(t, 'left', 0)),
                t.scrollbarYActive
                    ? e.classList.add(m.state.active('y'))
                    : (e.classList.remove(m.state.active('y')), (t.scrollbarYHeight = 0), (t.scrollbarYTop = 0), y(t, 'top', 0));
        },
        H = {
                ...
                t.event.bind(t.ownerDocument, 'keydown', function (n) {
                    if (!((n.isDefaultPrevented && n.isDefaultPrevented()) || n.defaultPrevented) && (r() || l())) {
                        ...
                        (t.settings.suppressScrollX && 0 !== s) ||
                            ...
                            (y(t, 'top', i.scrollTop - a), y(t, 'left', i.scrollLeft + s), L(t), e(s, a) && n.preventDefault());
                    }
                });
            },
            wheel: function (e) {
