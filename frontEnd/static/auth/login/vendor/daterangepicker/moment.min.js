...
!(function (a, b) {
    ...
    function fa(a, b, c) {
        ...
        for (
            this._monthsParse || ((this._monthsParse = []), (this._longMonthsParse = []), (this._shortMonthsParse = [])), d = 0;
            12 > d;
            d++
        ) {
            if (
        ...
        return (
            ...
            null === b || (void 0 === e && '' === b)
                ...
                : ('string' == typeof b && (a._i = b = a._locale.preparse(b)),
                  p(b) ? new o(ma(b)) : (c(e) ? Ea(a) : e ? Ca(a) : d(b) ? (a._d = b) : Ia(a), k(a) || (a._d = null), a))
        );
    }
    function Ia(b) {
        var f = b._i;
    ...
    function gb(a, b) {
        ...
        return a.isValid() && b.isValid()
            ? ((b = Sa(b, a)),
              a.isBefore(b) ? (c = fb(a, b)) : ((c = fb(b, a)), (c.milliseconds = -c.milliseconds), (c.months = -c.months)),
              c)
    ...
    function ib(a, b) {
        return function (c, d) {
            ...
            return (
                null === d ||
                    isNaN(+d) ||
                    (v(b, 'moment().' + b + '(period, number) is deprecated. Please use moment().' + b + '(number, period).'),
                    (f = c),
                    (c = d),
                    (d = f)),
