    ...
    (function () {
        ...
        var i =
            ...
            r = (function (t) {
                ...
                return (
                    (s = o()), (t.fn.emulateTransitionEnd = r), l.supportsTransitionEnd() && (t.event.special[l.TRANSITION_END] = i()), l
                );
            })(jQuery),
            s =
                ((function (t) {
                            ...
                            return (
                                ...
                                (a.prototype.show = function () {
                                    ...
                                    if (!this._isTransitioning && !t(this._element).hasClass(u.SHOW)) {
                                        ...
                                        if (
                                            (this._parent &&
                                                ((n = t.makeArray(t(this._parent).children().children(f.ACTIVES))).length || (n = null)),
                                            ...
                                            if ((t(this._element).trigger(o), !o.isDefaultPrevented())) {
                                                ...
                                                t(this._element).removeClass(u.COLLAPSE).addClass(u.COLLAPSING),
                                                    ...
                                                    this._triggerArray.length &&
                                                        t(this._triggerArray).removeClass(u.COLLAPSED).attr('aria-expanded', !0),
                                ...
                                (a.prototype.show = function () {
                                    ...
                                    if (this.isWithContent() && this._isEnabled) {
                                        ...
                                        r.supportsTransitionEnd() && t(this.tip).hasClass(p.FADE)
                                            ? t(this.tip).one(r.TRANSITION_END, u).emulateTransitionEnd(a._TRANSITION_DURATION)
                                            : u();
                                    }
                                }),
                                (a.prototype.hide = function (e) {
